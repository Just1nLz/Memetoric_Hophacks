...
const STEMS: Record<string, string[]> = {
  ...
  giving: ["giving"],
  voices: ["voices"],
  chronically: ["chronically", "terminally"],
  talking: ["talking"],
  nepo: ["nepo"],
  roman: ["roman", "empire"],
  ick: ["ick"],
  ...
  looksmaxxing: ["looksmaxx", "looksmaxxing", "looksmaxxed"],
  looksmaxx: ["looksmaxx", "looksmaxxing"],
  pick: ["pick"],
  tweaking: ["tweaking", "tweakin"],
  tweakin: ["tweaking", "tweakin"],
  cap: ["cap"],
  gigachad: ["gigachad", "chad"],
};
